...
export class AccountResource {
	...
	readonly folders = {
		...
		create: (body: { name: string; color?: WorkspaceFolderColor; position?: number }, options?: { signal?: AbortSignal; timeoutMs?: number }): Promise<APIWorkspaceResourceFolder> =>
			this.client.request({ method: "POST", path: "/v1/users/me/resource-organization/folders", body, signal: options?.signal, timeoutMs: options?.timeoutMs }),
		...
		update: (folderId: string, body: { name?: string; color?: WorkspaceFolderColor; position?: number }, options?: { signal?: AbortSignal; timeoutMs?: number }): Promise<APIWorkspaceResourceFolder> =>
			this.client.request({ method: "PATCH", path: `/v1/users/me/resource-organization/folders/${encodePathSegment(folderId)}`, body, signal: options?.signal, timeoutMs: options?.timeoutMs }),

		/** `DELETE /v1/users/me/resource-organization/folders/:folder_id` — scope `account:write`. */
		delete: (folderId: string, options?: { signal?: AbortSignal; timeoutMs?: number }): Promise<void> => this.client.request({ method: "DELETE", path: `/v1/users/me/resource-organization/folders/${encodePathSegment(folderId)}`, signal: options?.signal, timeoutMs: options?.timeoutMs }),

		/** `PUT /v1/users/me/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id` — scope `account:write`. */
		addResource: (folderId: string, resourceType: string, resourceId: string, body?: { position?: number }, options?: { signal?: AbortSignal; timeoutMs?: number }): Promise<APIWorkspaceResourceOrganization> =>
			this.client.request({
				method: "PUT",
				path: `/v1/users/me/resource-organization/folders/${encodePathSegment(folderId)}/resources/${encodePathSegment(resourceType)}/${encodePathSegment(resourceId)}`,
				body: body ?? {},
				signal: options?.signal,
				timeoutMs: options?.timeoutMs,
			}),

		/** `DELETE /v1/users/me/resource-organization/folders/:folder_id/resources/:resource_type/:resource_id` — scope `account:write`. */
	...
	readonly favorites = {
		/** `PUT /v1/users/me/resource-organization/favorites/:resource_type/:resource_id` — scope `account:write`. */
		add: (resourceType: string, resourceId: string, body?: { position?: number }, options?: { signal?: AbortSignal; timeoutMs?: number }): Promise<APIWorkspaceResourceOrganization> =>
			this.client.request({
				method: "PUT",
				path: `/v1/users/me/resource-organization/favorites/${encodePathSegment(resourceType)}/${encodePathSegment(resourceId)}`,
				body: body ?? {},
				signal: options?.signal,
				timeoutMs: options?.timeoutMs,
			}),

		/** `DELETE /v1/users/me/resource-organization/favorites/:resource_type/:resource_id` — scope `account:write`. */
